...
Scene_ChainCommand.prototype.createBackground = function() {
	...
	this.addChild(new Sprite(ImageManager.loadBitmap("img/chaincmd/", "bg")));
};
...
Scene_ChainCommand.prototype.createSequence = function() {
	...
	var x = (Graphics.boxWidth - button.width) / 2;
	var y = (Graphics.boxHeight - button.height) / 2;
...
Scene_ChainCommand.prototype.update = function() {
	...
	if (elapsed > ChainCommand.time) this.hasFailed();
